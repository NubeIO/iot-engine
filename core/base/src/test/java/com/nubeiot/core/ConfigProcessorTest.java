...
public class ConfigProcessorTest {
    ...
    public void test_env_config_is_json_but_provide_config_is_primitive() {
        ...
        Optional<NubeConfig> finalResult = this.processor.override(nubeConfig.toJson(), null, true, true);
    ...
    public void test_default_config_and_override_config() {
        ...
        Optional<NubeConfig> finalResult = this.processor.override(nubeConfig.toJson(), nubeConfig2.toJson(), true,
                                                                   true);
        Assert.assertTrue(finalResult.isPresent());
    ...
    public void test_double() {
        ...
        nubeConfig = IConfig.from(jsonInput, NubeConfig.class);
        Optional<NubeConfig> finalResult = this.processor.override(null, nubeConfig.toJson(), true, true);
        Assert.assertTrue(finalResult.isPresent());
        Object httpConfig = finalResult.get().getAppConfig().get("__http__");
        Assert.assertNotNull(httpConfig);
    ...
    public void test_override_none() {
        ...
        String jsonInput = "{\"__system__\":{\"__eventBus__\":{\"clientAuth\":\"REQUIRED\",\"ssl\":true," +
                           ...
                           ".name\":\"edge-connector\"}}";
        nubeConfig = IConfig.from(jsonInput, NubeConfig.class);
        Optional<NubeConfig> finalResult = this.processor.override(null, nubeConfig.toJson(), false, false);
    ...
    @Test
    public void test_override_system_secret_configs() {
        NubeConfig nubeConfig = IConfig.from(Configs.loadJsonConfig("nube.json"), NubeConfig.class);
        System.setProperty("nubeio.system.secret.@user", "test_user");
        System.setProperty("nubeio.system.secret.@test", "test");
        Optional<NubeConfig> result = processor.override(nubeConfig.toJson(), null, false, true);
    ...
    @Test
    public void test_override_app_secret_configs() {
        NubeConfig nubeConfig = IConfig.from(Configs.loadJsonConfig("nube.json"), NubeConfig.class);
        System.setProperty("nubeio.app.secret.@user", "test_user");
        System.setProperty("nubeio.app.secret.@test", "test");
        Optional<NubeConfig> result = processor.override(nubeConfig.toJson(), null, true, false);
        result.orElseThrow(() -> new NotFoundException("Not found"));
        result.ifPresent(finalResult -> {
    ...
    public void after() throws Exception {
        ...
        System.clearProperty("nubeio.app.secret.@user");
        System.clearProperty("nubeio.app.secret.@test");
        ...
        System.clearProperty("nubeio.system.secret.@user");
        System.clearProperty("nubeio.system.secret.@test");
    }
