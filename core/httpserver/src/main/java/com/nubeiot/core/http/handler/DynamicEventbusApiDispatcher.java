...
import com.nubeiot.core.http.rest.DynamicRestEventApi;
...
public class DynamicEventbusApiDispatcher<T extends DynamicRestEventApi> implements DynamicContextDispatcher<T> {
