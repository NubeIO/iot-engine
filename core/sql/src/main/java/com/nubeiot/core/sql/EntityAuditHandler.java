...
public interface EntityAuditHandler {
    ...
    static <M extends VertxPojo> M addCreationAudit(boolean auditEnabled, @NonNull M pojo, String createdBy) {
        return addCreationTimeAudit(auditEnabled, addNotSyncAudit(pojo), createdBy);
    }

    static <M extends VertxPojo> M addModifiedAudit(boolean auditEnabled, @NonNull M dbData, @NonNull M pojo,
                                                    String modifiedBy) {
