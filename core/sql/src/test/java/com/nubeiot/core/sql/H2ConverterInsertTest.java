...
public class H2ConverterInsertTest extends BaseSqlTest {
    ...
    public void before(TestContext context) {
        ...
        Single<Integer> insert1 = this.entityHandler.getSample01Dao()
                                                    .insert(new TblSample_01().setId(1)
        ...
        //f_duration = PT50H30M20S, id = P2Y3M4W5D
        Single<Integer> insert2 = this.entityHandler.getSample01Dao()
                                                    .insert(new TblSample_01().setId(2)
                                                                              .setFDate_1(LocalDate.of(2019, 2, 17))
                                                                              .setFTimestamp(
        ...
        Single.zip(insert1, insert2, (r1, r2) -> r1 + r2).subscribe(result -> {
