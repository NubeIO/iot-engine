 ...
 * @since 1.0.0
 */
public interface IBACnetDevice extends SharedDataDelegate<IBACnetDevice> {
     ...
     * @since 1.0.0
     */
    IBACnetDevice addListeners(@NonNull List<DeviceEventListener> listeners);
     ...
     * @since 1.0.0
     */
    default IBACnetDevice addListeners(DeviceEventListener... listeners) {
     ...
     * @since 1.0.0
     */
    @NonNull IBACnetDevice asyncStart();
