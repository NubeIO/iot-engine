...
public final class ThingService extends DataPointService<Integer, Thing, ThingRecord, ThingDao>
    implements SerialKeyEntity<Thing, ThingRecord, ThingDao> {

    public ThingService(@NonNull EntityHandler entityHandler, @NonNull HttpClientDelegate client) {
