...
public class ServerEventHandler implements EventHandler {
    ...
    public Single<JsonObject> getList(RequestData data) {
        ...
        //            String handlerAddress = endpointsMapper.getDriverHandler(DriverEventModels.POINTS, EventAction
        //            .GET_LIST,
        //                                                                     driver);
        ...
        //            //                ReplyEventHandler handler = new ReplyEventHandler("DriverAPI", EventAction
        //            .GET_LIST,
        //            //                handlerAddress,
        //            //                                                                  eventMessage -> {
        //            //                                                                      future.complete
