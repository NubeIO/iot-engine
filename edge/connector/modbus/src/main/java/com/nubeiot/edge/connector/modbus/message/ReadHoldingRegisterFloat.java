 ...
 */
public abstract class ReadHoldingRegisterFloat implements FloatOperation {

    public static Builder builder() {
        return new AutoValue_ReadHoldingRegisterFloat.Builder()
                .setType(Type.READ_HOLDING_REGISTER_FLOAT)
                .setByteCount(4)
    ...
    public abstract static class Builder {
        ...
        public abstract ReadHoldingRegisterFloat build();
    }

    public static TypeAdapter<ReadHoldingRegisterFloat> typeAdapter(Gson gson) {
        return new AutoValue_ReadHoldingRegisterFloat.GsonTypeAdapter(gson);
    }
}
