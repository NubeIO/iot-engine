 ...
 */
public abstract class ReadHoldingRegisterString implements StringOperation {
    public static Builder builder() {
        return new AutoValue_ReadHoldingRegisterString.Builder()
                .setType(Type.READ_HOLDING_REGISTER_STRING)
                .setByteCount(1);
    }
    ...
    public abstract static class Builder {
        ...
        public abstract ReadHoldingRegisterString build();
    }

    public static TypeAdapter<ReadHoldingRegisterString> typeAdapter(Gson gson) {
        return new AutoValue_ReadHoldingRegisterString.GsonTypeAdapter(gson);
    }
}
