...
CREATE INDEX IDX_TRANSDUCER_CATEGORY ON TRANSDUCER ( TRANSDUCER_CATEGORY );
...
CREATE INDEX IDX_FOLDER ON FOLDER ( NAME );
...
CREATE TABLE IF NOT EXISTS FOLDER_GROUP (
	...
	TIME_AUDIT           varchar(500)   ,
	SYNC_AUDIT           clob(2147483647)   ,
    CONSTRAINT PK_FOLDER_GROUP PRIMARY KEY ( ID )
);

CREATE INDEX IDX_FOLDER_GROUP_FOLDER ON FOLDER_GROUP ( FOLDER_ID );
...
COMMENT ON COLUMN FOLDER_GROUP.GROUP_TYPE IS 'DEVICE or POINT or FOLDER';
...
ALTER TABLE FOLDER_GROUP ADD CONSTRAINT FK_FOLDER_GROUP_FOLDER FOREIGN KEY ( FOLDER_ID ) REFERENCES FOLDER( ID ) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE FOLDER_GROUP ADD CONSTRAINT FK_FOLDER_GROUP_PARENT_FOLDER FOREIGN KEY ( PARENT_FOLDER_ID ) REFERENCES FOLDER( ID ) ON DELETE CASCADE ON UPDATE CASCADE;
