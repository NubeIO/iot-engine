...
public final class NotInBuilder extends AbstractComparisionCriteriaBuilder {

    static final ComparisonOperator OPERATOR = RSQLOperators.NOT_IN;

    public NotInBuilder(@NonNull ComparisonNode node) {
        super(node);
    }
