...
public class FileUtilsTest {
    ...
    public void test_default_datadir() {
        Assert.assertEquals(Paths.get(System.getProperty("user.home"), ".test"),
                            FileUtils.resolveDataFolder(DEFAULT_DATADIR, null));
        Assert.assertEquals(Paths.get(System.getProperty("user.home"), ".test"),
                            FileUtils.resolveDataFolder(DEFAULT_DATADIR, ""));
    }

    @Test
    public void test_datadir_with_non_absolute_given_path() {
        Path dataDir = Paths.get(System.getProperty("user.home"), ".test", "folder");
        System.out.println(dataDir);
        Assert.assertEquals(dataDir.toString(), FileUtils.resolveDataFolder(DEFAULT_DATADIR, "folder").toString());
    }
    ...
    public void test_datadir_with_absolute_given_path() throws IOException {
        ...
        System.out.println(dataDir);
        Assert.assertEquals(dataDir.toString(),
                            FileUtils.resolveDataFolder(DEFAULT_DATADIR, dataDir.toString()).toString());
    }
    ...
    public void test_create_dir_with_absolute_given_path() throws IOException {
        ...
        Assert.assertEquals(subFolder.toString(), FileUtils.createFolder(DEFAULT_DATADIR, dataDir.toString(), "123"));
    ...
    public void test_recompute_datadir_1() {
        Assert.assertEquals(DEFAULT_DATADIR.resolve("test"),
                            FileUtils.recomputeDataDir(DEFAULT_DATADIR, DEFAULT_DATADIR, "test"));
    }

    @Test
    public void test_recompute_datadir_2() {
        Path path = FileUtils.recomputeDataDir(DEFAULT_DATADIR, OSHelper.getAbsolutePathByOs("/data"),
                                               DEFAULT_DATADIR.resolve("test").toString());
    ...
    public void test_recompute_datadir_3() {
        Path path = FileUtils.recomputeDataDir(DEFAULT_DATADIR, OSHelper.getAbsolutePathByOs("/data"),
                                               DEFAULT_DATADIR.resolve("test/xyz").toString());
        Assert.assertEquals(OSHelper.getAbsolutePathByOs("/data/test/xyz"), path);
    }

    @Test
    public void test_recompute_datadir_4() {
        Path path = FileUtils.recomputeDataDir(DEFAULT_DATADIR, OSHelper.getAbsolutePathByOs("/data"), "test");
        Assert.assertEquals(OSHelper.getAbsolutePathByOs("/data/test"), path);
    }
    ...
    public void test_recompute_datadir_6() {
        Path path = FileUtils.recomputeDataDir(DEFAULT_DATADIR, Paths.get("/data"),
    ...
    public void test_recompute_datadir_7() {
        Path path = FileUtils.recomputeDataDir(DEFAULT_DATADIR, DEFAULT_DATADIR.resolve("test"),
                                               OSHelper.getAbsolutePathByOs("/home/test").toString());
        Assert.assertEquals(OSHelper.getAbsolutePathByOs("/home/test"), path);
    }
