...
public class EdgeDittoDriver extends RxMicroServiceVerticle {
    ...
    private Single<Record> publishHttp() {
        return publishHttpEndpoint("io.nubespark.edge-ditto-driver", "0.0.0.0", config().getInteger("http.port", EDGE_DITTO_DRIVER_PORT))
    ...
    private Single<HttpServer> startWebApp() {
        ...
        return vertx.createHttpServer()
            ...
            .rxListen(config().getInteger("http.port", EDGE_DITTO_DRIVER_PORT))
